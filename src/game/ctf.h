...
#endif
{
    ...
    {
        flag &f = flags[i];
        settexture(m_hold && (!flagblip || !f.owner || lastmillis%1000 < 500) ? (flagblip ? "packages/interface/blip_neutral_flag.png" : "packages/interface/blip_neutral.png") :
                    ((m_hold ? ctfteamflag(f.owner->team) : f.team)==ctfteamflag(player1->team) ?
                        (flagblip ? "packages/interface/blip_blue_flag.png" : "packages/interface/blip_blue.png") :
                        (flagblip ? "packages/interface/blip_red_flag.png" : "packages/interface/blip_red.png")), 3);
    ...
    void drawhud(fpsent *d, int w, int h)
    {
        ...
        if(m_hold)
        {
            settexture("packages/interface/blip_neutral.png", 3);
