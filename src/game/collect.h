...
#endif
{
    ...
    {
        base &b = bases[i];
        settexture(b.team==collectteambase(player1->team) ? "packages/interface/blip_blue.png" : "packages/interface/blip_red.png", 3);
    ...
    void drawhud(fpsent *d, int w, int h)
    {
        ...
        settexture(team == collectteambase(player1->team) ? "packages/interface/blip_red_skull.png" : "packages/interface/blip_blue_skull.png", 3);
        loopv(players)
        {
            fpsent *o = players[i];
    ...
    void rendergame()
    {
        ...
        const int mdlFlags = MDL_CULL_VFC|MDL_CULL_OCCLUDED;
        ...
        loopv(bases)
        {
            ...
            rendermodel(b.team==team ? "skull/blue" : "skull/red", animFlags, tokenpos, lastmillis/10.0f, 0, 0, mdlFlags, NULL, NULL, 0, 0, alpha);
        ...
        loopv(tokens)
        {
            ...
            rendermodel(t.team == team || (t.team < 0 && -t.team != team) ? "skull/blue" : "skull/red", animFlags, p, lastmillis/10.0f, 0, 0, mdlFlags | MDL_CULL_DIST);
        }
        ...
        loopv(players)
        {
            ...
            loopj(d->tokens)
            {
                rendermodel(dteam != team ? "skull/blue" : "skull/red", animFlags, pos, d->yaw+90, 0, 0, mdlFlags | MDL_CULL_DIST);
                pos.z += TOKENHEIGHT + 1;
            }
        }
    }
