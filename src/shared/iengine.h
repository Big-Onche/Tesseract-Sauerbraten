...
enum
{
    ...
    PART_HAZE_NOISE, PART_HAZE_MUZZLE_FLASH,
    PART_LENS_FLARE
};
...
extern void setfirstpersonmodel(bool enable);
...
extern void renderclient(dynent *d, const char *mdlname, modelattach *attachments, int hold, int attack, int attackdelay, int lastaction, int lastpain, float fade = 1, bool ragdoll = false, bool onlyshadow = false, int flags = 0);
